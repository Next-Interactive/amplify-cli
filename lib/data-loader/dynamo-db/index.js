            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                data: (0, utils_1.mapTableObject)(Responses, function (items) { return items.map(function (item) { return (0, utils_1.unmarshall)(item); }); }),
                                unprocessedKeys: (0, utils_1.mapTableObject)(UnprocessedKeys || {}, function (request) { return request.Keys.map(function (key) { return (0, utils_1.unmarshall)(key); }); }),
                            }];
                }
            });
        });
