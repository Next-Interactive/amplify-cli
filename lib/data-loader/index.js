...
addDataLoader("AMAZON_DYNAMODB" /* DynamoDB */, dynamo_db_1.DynamoDBDataLoader);
addDataLoader("NONE" /* None */, none_1.NoneDataLoader);
addDataLoader("AWS_LAMBDA" /* Lambda */, lambda_1.LambdaDataLoader);
addDataLoader("AMAZON_OPENSEARCH_SERVICE" /* OpenSearch */, opensearch_1.OpenSearchDataLoader);
