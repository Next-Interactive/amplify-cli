            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, response.status(200).send({ message: "Successfully deleted " + JSON.stringify(deletedItems) + " tables" })];
                    case 3:
                        e_1 = _a.sent();
                        console.error("Error clearing DB data. Error: " + e_1.message);
