...
var SubscriptionServer = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        e_1 = _b.sent();
                        throw new Error("Port ".concat(this.port, " is already in use. Please kill the program using this port and restart Mock"));
                    case 5:
                        server = this.mqttWebSocketServer.listen(this.port);
                        return [4 /*yield*/, (0, promise_toolbox_1.fromEvent)(server, 'listening').then(function () {
                                var address = server.address();
                                _this.url = "ws://".concat((0, ip_1.address)(), ":").concat(address.port, "/");
                                return server;
                            })];
    ...
    SubscriptionServer.prototype.afterMQTTClientConnect = function (client) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                clientId = client.id;
                log.info("Client (".concat(chalk_1.default.bold(clientId), ") connected to subscription server"));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        clientId = client.id;
                        log.info("Client (".concat(chalk_1.default.bold(clientId), ") subscribed to topic ").concat(topic));
                        regs = this.clientRegistry.get(clientId);
                        if (!regs) {
                            log.error("No registration for client (".concat(chalk_1.default.bold(clientId), ")"));
                            return [2 /*return*/];
                        }
                        ...
                        if (!reg) {
                            log.error("Client (".concat(chalk_1.default.bold(clientId), ") tried to subscribe to non-existent topic ").concat(topic));
                            return [2 /*return*/];
                        }
                    ...
                    case 2:
                        ...
                        log.info("Publishing payload for topic ".concat(topicId));
                        log.log('Payload:');
    ...
    SubscriptionServer.prototype.afterMQTTClientUnsubscribe = function (topic, client) {
        ...
        log.info("Client (".concat(chalk_1.default.bold(clientId), ") unsubscribed from topic ").concat(topic));
        ...
        if (!reg) {
            log.error("Client (".concat(chalk_1.default.bold(clientId), ") tried to unsubscribe from non-existent topic ").concat(topic));
            return;
        }
    ...
    SubscriptionServer.prototype.afterMQTTClientDisconnect = function (client) {
        var clientId = client.id;
        log.info("Client (".concat(chalk_1.default.bold(clientId), ") disconnected"));
        var reg = this.clientRegistry.get(clientId);
        if (!reg) {
            log.error("Unregistered client (".concat(chalk_1.default.bold(clientId), ") disconnected"));
        }
    ...
    SubscriptionServer.prototype.register = function (document, variables, context, asyncIterator) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                remoteAddress = "".concat(connection.remoteAddress, ":").concat(connection.remotePort);
                clientId = crypto_1.default.createHash('MD5').update(remoteAddress).digest().toString('hex');
                ...
                log.info("Client (".concat(chalk_1.default.bold(clientId), ") registered for topic ").concat(topicId));
                registration = {
                    context: context,
                    document: document,
                    variables: variables,
