...
const getYarnPackageManager = async (rootPath) => {
    ...
    return {
        ...
        version: (_a = (0, semver_1.coerce)(await (0, shell_utils_1.execWithOutputAsString)(`${packageManagers.yarn.executable} --version`, { cwd: rootPath }))) !== null && _a !== void 0 ? _a : undefined,
    };
};
